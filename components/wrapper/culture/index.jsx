                ...
                <div className="flex h-full md:flex-row flex-col-reverse">
                    <div className='basis-full md:basis-[50%] px-[5%] py-12'>
                        ...
                        <Suspense fallback={<LoadingPlaceholder />}>
                            <CustomLink linkTitle={data?.missionLinkTitle} linkHref={buildRegionalPath(data?.missionLinkHref, region, regions?.data)} linkClass="text-small-con bg-white hover:bg-transparent text-[var(--mainColor)] hover:text-white border border-white mt-4" />
                        </Suspense>
                    </div>
            ...
            <div className="container">
                <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-10 mb-14">
                    ...
                    <div className="basis-full md:basis-1/2 mb-8 md:mb-0">
                        ...
                        <Suspense fallback={<LoadingPlaceholder />}>
                            <CustomLink linkTitle={data?.growthLinkTitle} linkHref={buildRegionalPath(data?.growthLinkHref, region, regions?.data)} linkClass="text-small-con bg-[var(--mainColor)] hover:bg-transparent text-white hover:text-[var(--mainColor)] border border-[var(--mainColor)]" />
                        </Suspense>
                    </div>
            ...
            <div className='bg-[var(--mainColor)] md:py-14 py-12'>
                <div className="container">
                    <div className="flex flex-col md:flex-row md:justify-between md:items-start items-center">
                        ...
                        <Suspense fallback={<LoadingPlaceholder />}>
                            <CustomLink linkTitle={data?.ctaLinkTitle} linkHref={buildRegionalPath(data?.ctaLinkHref, region, regions.data)} linkClass="text-small-con bg-white hover:bg-transparent text-[var(--mainColor)] hover:text-white border border-white" />
                        </Suspense>
                    </div>
                </div>
            </div>
